events = [
    ...
    { title:"Murad bayrami", date : "18.10.2022" },
]
let event_list=[]
...
function start(){
    ...
    get_element.childNodes.forEach(d => d.addEventListener('click',(e)=>{
        ...
        if(date.getMonth()+1 == Number(event_list[i].month) && date.getFullYear() == Number(event_list[i].year) && date.getDate() == Number(event_list[i].day)){
           ...
           if(i<event_list.length-2){
            document.querySelector('.next1').innerHTML = event_list[i+1].title.toString()+' ' +event_list[i+1].day.toString()
            document.querySelector('.next2').innerHTML = event_list[i+2].title.toString()+' ' +event_list[i+2].day.toString()
           }else if(i<event_list.length-1){
            document.querySelector('.next1').innerHTML = event_list[i+1].title.toString()+' ' +event_list[i+1].day.toString()
           }
    ...
    get_element.childNodes.forEach(d => d.addEventListener('click',(e)=>{
        ...
        if(date.getMonth()+1 == Number(event_list[i].month) && date.getFullYear() == Number(event_list[i].year) && date.getDate() == Number(event_list[i].day)){
           ...
           if(i<event_list.length-2){
            ...
            document.querySelector('.next1').innerHTML ='none'
           }
           break;
        }else{
            document.querySelector('.title').innerHTML=''
